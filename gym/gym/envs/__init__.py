...
register(
    id='AppPrediction-v4',
    entry_point='gym.envs.appPrediction:AppPredictionV4',
    reward_threshold=100,
    timestep_limit=16838,
    trials=100,
    kwargs={'properties': {
                'expl_subset_limit': 20,
                "guided_exploration": False,
                'local': {'train': False,
                          'path': '../data/app',
                          'info': 'app.info',
                          'apps_collection': 'apps.npy',
                          'transitionmatrix_collection': 'trans.npy',
                          'records_collection': 'usingapp.npy',
                          'predicted_records': 'ranking.npy'}
            }},
    nondeterministic=False,
)
